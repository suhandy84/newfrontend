...
class Search extends Component {
    ...
    async componentDidMount() {
        try {
            console.log(this.props.match.params.iddisc)
            var res = await Axios.get(`${APIURL}/product/getdiscountprod/${this.props.match.params.iddisc}`)
            this.setState({ products: res.data, discountrate: res.data[0].discount_rate })
            console.log(res.data[0].discount_rate)
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-9 row mt-5 p-0" style={{ height: "30px" }}>
                            <div className="col-12 display-10 text-left mb-2 shadow-sm p-2 card ">Produk Diskon {this.state.discountrate}% :</div>
                            {/* {this.renderList()} */}
